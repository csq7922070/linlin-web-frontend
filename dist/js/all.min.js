...
(function() {
    angular.module('app.notice').controller("noticeDetailCtrl", ['$scope', '$http', '$stateParams', 'notices',
        function($scope, $http, $stateParams, notices) {
            notices.get({
                id: $stateParams.id
...
(function() {
    angular.module('app.notice').controller('noticeListCtrl', ['$scope', '$http', 'notices',
        function($scope, $http, notices) {
            $scope.currentPage = 0;
            $scope.pageSize = 10;
            $scope.load = function(goPage, limit) {
                if (goPage > $scope.numberOfPages || $scope.currentPage == goPage || goPage < 1 || $scope.busy) {
...
(function() {
    angular.module('app.repair').controller('repairAddCtrl', ['$timeout', '$state', 'repairs',
        function($timeout, $state, repairs) {
            ...
            function successcb() {
                vm.suc_show = true;
                console.log("vm.suc_show "+vm.suc_show);
                $timeout(function() {
                    vm.suc_show = false;
                    $state.go("repair");
                }, 3000);
...
(function() {
    angular.module('app.repair').controller('repairDetailCtrl', ['$http', '$state', '$stateParams', '$timeout', 'repairs',
        function($http, $state, $stateParams, $timeout, repairs, curd) {
            var vm = this;
            vm.suc_show = false;
            vm.err_show = false;
...
angular.module('app.repair').controller('repairListCtrl', ['$http', '$timeout', '$state', 'repairs',
    function($http, $timeout, $state, repairs) {
        var vm = this;
        vm.currentPage = 0;
        vm.pageSize = 10;
        vm.suc_show = false;
